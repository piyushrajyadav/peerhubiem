...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/peerhub101/',
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.instagram.com/peerhb_iem_kolkata/',
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
          ...
          >
            ...
            <div>
              ...
              <address className="mt-4 not-italic text-gray-600 dark:text-gray-300">
                IEM Campus<br />
                Management House, College More<br />
                Kolkata, West Bengal 700040<br />
                India
              </address>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Email Us</h2>
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                <a href="mailto:contact@peerhub.com" className="text-primary-600 hover:text-primary-500">
                  anand.kumarsingh2023@iem.edu.in
                </a>
              </p>
            </div>
          </motion.div>
